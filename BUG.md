...
**Версия:** 3.1 (OCR исправлен, backfill запущен)  
**Статус:** 40 багов к исправлению (1 решён — OCR читает с фото)
...
**Всего найдено:** 41 баг; **исправлено:** 1 (OCR)
...
- **Приоритет:** 🟠 ВЫСОКИЙ
- **Статус:** 🔴 Открыт (обнаружен 2026-05-29)
...
**Версия:** 3.2 (backfill-цикл исправлен)
